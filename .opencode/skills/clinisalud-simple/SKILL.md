...
- **Fuente de Verdad:** Antes de implementar cualquier servicio, controlador, componente o test, DEBES leer el archivo `/docs/spec/CLINISALUD-SPEC-CORE.md` ubicado en la raíz del proyecto.
